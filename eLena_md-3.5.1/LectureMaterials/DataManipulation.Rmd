...
Go through the exercises in [Data Manipulation Exercise Block 1](https://e-learn.csc.fi/mod/resource/view.php?id=580) (~5 mins).
...
Go through [Data Manipulation Exercise Block 2](https://e-learn.csc.fi/mod/resource/view.php?id=580) (~5-10 mins).
...
There are a few other things we can try out using the split-apply-combine paradigm. Let's try these out by going through the exercises in [Data Manipulation Exercise Block 3](https://e-learn.csc.fi/mod/resource/view.php?id=580) (10-15 mins).
...
Let's have a look at the counting exercises in [Data Manipulation Exercise Block 4](https://e-learn.csc.fi/mod/resource/view.php?id=580) (~10 mins).
...
Have a look at [Data Manipulation Exercise Block 5](https://e-learn.csc.fi/mod/resource/view.php?id=580) (~15 mins).
...
To make sure we're all on the same page, these steps are replicated in [Data Manipulation Exercise Block 6](https://e-learn.csc.fi/mod/resource/view.php?id=580). Take some time (~5-10 mins) to run through them.
