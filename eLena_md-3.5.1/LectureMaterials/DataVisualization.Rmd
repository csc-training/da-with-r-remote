...
At this point, let's complete [Data Visualization Exercise Block 1](https://e-learn.csc.fi/mod/resource/view.php?id=556) (~ 10 mins). 
...
Let's complete [Data Visualization Exercise Block 2](https://e-learn.csc.fi/mod/resource/view.php?id=556) (~ 10-15 mins). 
...
Complete [Data Visualization Exercise Block 3](https://e-learn.csc.fi/mod/resource/view.php?id=556) (~ 5-10 mins).
...
Let's have a look at [Data Visualization Exercise Block 4](https://e-learn.csc.fi/mod/resource/view.php?id=556) (~ 5-10 mins).
...
At this point, let's take some time to repeat some of the steps above, so that each of us has the `yearly_counts` data set ready. We can find steps for this in [Data Visualization Exercise Block 5](https://e-learn.csc.fi/mod/resource/view.php?id=556) (~ 5 mins).
...
Those are some hefty bits of code! Before looking at arranging and exporting plots, let's break things up a little and check out [Data Visualization Exercise Block 7](https://e-learn.csc.fi/mod/resource/view.php?id=556) (~ 5-10 mins).
...
These steps are replicated in [Data Visualization Exercise Block 8](https://e-learn.csc.fi/mod/resource/view.php?id=556) (~ 5-10 mins). We'll also go through steps to save your R script and data, and export everything to your own computer.
