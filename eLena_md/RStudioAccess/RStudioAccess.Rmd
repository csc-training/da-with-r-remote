...
3. You should see a workspace with an RStudio environment called "RStudio Server (Data Analysis with R, February 2023)". Later you can find it under "My workspaces".
