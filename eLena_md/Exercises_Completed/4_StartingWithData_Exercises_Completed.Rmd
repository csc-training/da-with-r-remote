...
**1.2** Import some example data (`/data/portal_data_joined.csv`) into an object called `surveys`. When importing the data, use the argument `stringsAsFactors = TRUE`. You can use `head()` to check that everything got imported correctly.
...
carSpeeds <- read.csv("/data/car-speeds.csv", header = FALSE)
str(carSpeeds)
