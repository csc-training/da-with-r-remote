...
**4.3** What was the heaviest animal measured in each year? Return the columns `year`, `genus`, `species_id`, and `weight`. Hint: you can use the argument `by`
also with some dplyr functions that `summarize`.
