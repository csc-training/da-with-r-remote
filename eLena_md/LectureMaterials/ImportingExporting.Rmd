...
Use Save As and choose CSV as the file format (click on the links to see examples as images): File -> [Save As](eLena_md/LectureMaterials/Images/excel_save_as.png) -> [File Format](eLena_md/LectureMaterials/Images/excel_file_format.png): [Comma-separated values (.csv)](eLena_md/LectureMaterials/Images/excel_file_name.png). 
