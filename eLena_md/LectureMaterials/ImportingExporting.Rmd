...
Use Save As and choose CSV as the file format (click on the links to see examples as images): File -> [Save As](https://github.com/csc-training/da-with-r-remote/blob/master/eLena_md/LectureMaterials/Images/excel_save_as.png) -> [File Format](https://github.com/csc-training/da-with-r-remote/blob/master/eLena_md/LectureMaterials/Images/excel_file_format.png): [Comma-separated values (.csv)](https://github.com/csc-training/da-with-r-remote/blob/master/eLena_md/LectureMaterials/Images/excel_file_name.png). 
