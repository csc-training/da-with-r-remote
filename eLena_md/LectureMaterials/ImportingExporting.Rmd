...
Use Save As and choose CSV as the file format (click on the links to see examples as images): File -> [Save As](Images/excel_save_as.png) -> [File Format](Images/excel_file_format.png): [Comma-separated values (.csv)](Images/excel_file_name.png). 
