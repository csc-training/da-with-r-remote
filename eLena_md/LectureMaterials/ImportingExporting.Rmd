...
5. Export the cleaned data to a text-based format like CSV (comma-separated values) format. This ensures that anyone can use the data, and is required by most data repositories. For example, exporting an Excel spreadsheet as a CSV: File -> Save as -> File Format: Comma-separated values (.csv).
