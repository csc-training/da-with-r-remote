...
After columns with standard errors and test statistics, we see a column containing *P* values for the coefficients. The model shows that `body_mass` is positively associated with `flipper_len` (*P* \< 0.001). The intercept is also significantly different from zero (which is nearly always the case).
